...
Плагин "Указка" позволяет:
- Автоматически загружать изображение указки с сервера
- Добавлять указку на Canvas одним кликом
- Проигрывать звук клика с регулируемой громкостью
- Анимировать указку при клике
...
cd figmapluginApi2. Установите зависимости:
npm install3. Соберите проект:
npm run build
...
Разработано для удобной работы с презентациями в Figma.
