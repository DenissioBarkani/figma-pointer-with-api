...
Плагин для добавления интерактивной указки с анимацией и звуком для удобной работы с ЗУМЕРАМИ в Figma.
...
```bash
git clone https://github.com/DenissioBarkani/figma-pointer-with-api.git
cd figmapluginApi
```
